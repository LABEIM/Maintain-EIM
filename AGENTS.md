# AGENTS.md — Coming Soon & Maintenance Hub (comingsoon-eim)
...
4. Documentation in `README.md` and `SETUP.md` is updated if new configuration keys or templates are introduced.
