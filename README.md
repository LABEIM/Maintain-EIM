...
This template provides zero-build static hosting, centralized zero-code configuration via `config.js`, light and dark mode support, and automated CI/CD deployment to Cloudflare Pages via the [LABEIM Shared CI/CD](https://github.com/LABEIM/shared-ci-cd) workflow.
...
├── config.js              # Central configuration file (customize content here)
...
3. Customize title, logo, headings, links, and footer in [config.js](file:///home/arukast/Projects/comingsoon-eim/config.js).
